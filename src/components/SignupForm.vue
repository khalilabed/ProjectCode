<template>
  ...
  <div class="container">
    <h2 class="login-title">قم بانشاء حساب  </h2>

    <form class="login-form" @submit.prevent="userRegistration">
      <div>
        <label for="email" class="fw-bold">الاسم  :</label>
        <input id="email" type="text" placeholder="ادخل اسمك ..." name="text" required  v-model="user.name"  />
      </div>
      <div class="my-2">
        <label for="email" class="fw-bold my-2">البريد الالكتروني  :</label>
